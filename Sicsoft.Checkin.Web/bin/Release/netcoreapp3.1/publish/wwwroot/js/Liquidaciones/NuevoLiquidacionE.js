...
$(document).ready(function () {
    jQuery(document).ready(function ($) {
        $(document).ready(function () {
            ...
            $("#NumFactura").inputmask({ "mask": "999-999-999999999" });
        ...
        $.ajax({
            ...
            success: function (result) {
                ...
                if (result != null) {
                    ...
                    $("#CodProveedor").inputmask({ "mask": "9999999999999" });
                        ...
                        success: function (json) {
                            ...
                            if (json == "true") {
                                Swal.fire({
                                    ...
                                    if (result.isConfirmed) {
                                        window.location.href = window.location.href.split("/NuevoE")[0];
                                    }
                                })
...
function GeneraryEnviar() {
    try {
        ...
        var Cadena = [];
        if (EncCompras.Impuesto1 == "") {
            EncCompras.Impuesto1 = "0";
        }
        if (EncCompras.Impuesto4 == "") {
            EncCompras.Impuesto4 = "0";
        }
...
function AgregarProductosI() {
    try {
        ...
        var detalle = {
            ...
            CodPro: "1",
            NomPro: ($("#NomPro").val() == "" ? "Detalle factura" : (selected.toUpperCase().includes("Comb".toUpperCase()) ? $("#NomPro").val() + " * " + $("#idTipoComb").val() : $("#NomPro").val())),
...
function GenerarI() {
    try {
        ...
        var NumFacturaI = $("#NumFactura").val();
