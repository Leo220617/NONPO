    ...
    try {
        ...
        for (var i = 0; i < det.length; i++) {
            ...
            var detalle =
            {
                ...
                CantidadRecibido: det[i].CantidadRecibido,
...
function onClickModal(id) {
    ...
    for (var i = 0; i < LotesArray.length; i++) {
        ...
        sOptions += "<div class='col-2'> <div class='form-group'> <h5>Lote</h5> <div class='controls'> <input type='text' readonly class='form-control' value='" + LotesArray[i].Lote + "' id='lote" + i + "'> </div></div> </div>";
        ...
        sOptions += "<div class='col-3' > <div class='form-group'> <h5>Estado</h5> <div class='controls'> <input type='text' readonly id='estado" + i + "' class='form-control' value='" + EstadosLotes.filter(a => a.id == LotesArray[i].idEstado)[0].Estado + "'> </div></div> </div> ";
...
function rellenaRowLotes() {
    ...
    sOptions += "<div class='col-2'> <div class='form-group'> <h5>Lote</h5> <div class='controls'> <input type='text' class='form-control'   id='lote" + z + "'> </div></div> </div>";
    ...
    sOptions += "<div class='col-3'> <div class='form-group'> <h5>F.Vencimiento</h5> <div class='controls'> <input type='date'  id='fechavencimiento" + z + "' class='form-control'  > </div>  </div> </div> ";
    sOptions += "<div class='col-3' > <div class='form-group'> <h5>Estado</h5> <div class='controls'> <select class='form-control' id='estado" + i + "'> ";
    ...
    sOptions += "<div class='col-2'> <div class='form-group'> <h5>Cantidad</h5> <div class='controls'> <input type='number'  id='cantidad" + z + "' class='form-control'  > </div>  </div> </div> ";
...
function ValidarLinea(z) {
    try {
        ...
        if ($("#lote" + z).val() == "") {
            ...
            return false;
        } else if (parseInt($("#cantidad" + z).val()) + cantidades > parseInt(prod.CantidadRecibido + prod.CantidadRecibidoAE)) {
            Swal.fire({
                icon: 'error',
                title: 'Oops...',
...
function onChangeCantidadRecibido(i) {
    ...
    Detalle[i].CantidadRecibido = parseInt($("#Cantidad_" + i).val());
...
function Generar() {
    ...
    Swal.fire({
        title: '¿Desea guardar los cambios de esta orden de compra?',
        showDenyButton: true,
        ...
        if (result.isConfirmed) {
            ...
            var enviar = {
                ...
                CodigoProveedor: "",
                NombreProveedor: "",
                Fecha: $("#fechaRecibido").val(),
                FechaRecibir: $("#fechaRecibido").val(),
...
function GeneraryEnviar() {
    ...
    Swal.fire({
        title: '¿Desea guardar los cambios y enviar a SAP esta orden de compra?',
        showDenyButton: true,
        showCancelButton: false,
        confirmButtonText: `Aceptar`,
        denyButtonText: `Cancelar`,
